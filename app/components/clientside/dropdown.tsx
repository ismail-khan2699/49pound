  ...
  return (
    ...
    <div className="md:hidden">
      ...
      {isMenuOpen ? <ImCross className=" text-white h-6 w-auto hover:scale-95" />: <AiOutlineMenuFold className=" text-white h-8 w-auto hover:scale-95" />}
        ...
        <div className="hidden ml-auto md:flex md:items-center md:justify-center md:space-x-5 lg:space-x-10">
               ...
               <div className="absolute z-10 hidden w-56 bg-white border border-gray-200 shadow-lg rounded-lg group-hover:block">
                 <ul className=" rounded-lg overflow-hidden">
                  {WedData.map(item=>(
                   ...
                   <Link href="#" title="" className="inline-flex items-center justify-center px-5 py-2.5 text-xl  text-custom-magenta border-2 hover:border-gray-300 rounded-lg hover:bg-black hover:text-white transition-all duration-200 focus:bg-black focus:text-white" role="button"> Sign in </Link>
